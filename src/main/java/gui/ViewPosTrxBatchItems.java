...
public class ViewPosTrxBatchItems extends JDialog {
	...
	private ViewPosTrxBatchItemsCtrl ctrl;
	 ...
	 */
	public ViewPosTrxBatchItems ( Frame owner, ViewPosTrxBatchItemsCtrl ctrl ) {
	...
	private void initialize() {
		...
		this.setName("ViewPosTrxBatchItems");
		this.setModal(true);
		...
		//
		this.setTitle("Items de Lotes de Documentos POS");
	...
	public static void main(String[] args) {
		...
		//
		ViewPosTrxBatchItems w = new ViewPosTrxBatchItems(null, new ViewPosTrxBatchItemsCtrl());
		w.setVisible(true);
		w.repaint();
	}
