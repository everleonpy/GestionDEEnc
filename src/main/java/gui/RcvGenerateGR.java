...
public class RcvGenerateGR extends JFrame {
	...
	public static void main(String[] args) {
		...
		//
		RcvGenerateGR w = new RcvGenerateGR();
		w.setVisible(true);
		w.repaint();
	}
