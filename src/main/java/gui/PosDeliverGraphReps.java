...
public class PosDeliverGraphReps extends JFrame {
	...
	private void initialize() {
		...
		this.setName("PosDeliverGraphReps");
		this.setResizable(false);
		this.setLayout(new BorderLayout());
		//this.setContentPane(new JLabel(new ImageIcon(AppConfig.iconsFolder + "main-bg.jpg")));
		this.add(getJContentPane());
		//
		this.setTitle("Envio de Representaciones Graficas de Facturas POS");
			    ...
			    public void mouseClicked(MouseEvent e) {  
			        ...
			        if (rowIndex >= 0) {
			            ...
			            ctrl.setSelectedTransactionId(invoiceId);
			    	        ApplicationMessage m = ctrl.deliverGraphRepresent(invoiceId, controlId, cashId, txNumber, txDate);
	...
	public static void main(String[] args) {
		...
		//
		PosDeliverGraphReps w = new PosDeliverGraphReps();
		w.setVisible(true);
		w.repaint();
	}
