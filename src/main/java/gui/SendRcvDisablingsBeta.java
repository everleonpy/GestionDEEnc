...
public class SendRcvDisablingsBeta extends JFrame {
	...
	private SendRcvDisablingsController ctrl;
	...
	public SendRcvDisablingsBeta () {
	    ...
	    this.ctrl = new SendRcvDisablingsController();
		// build GUI
		initialize();
		try {		
	...
	private void initialize() {
		...
		this.setName("SendRcvDisablingsBeta");
		this.setResizable(false);
		this.setLayout(new BorderLayout());
		//this.setContentPane(new JLabel(new ImageIcon(AppConfig.iconsFolder + "main-bg.jpg")));
		this.add(getJContentPane());
		//
		this.setTitle("Inutilizacion de Numeros de Comprobantes Mayoristas");
	...
	public static void main(String[] args) {
		...
		//
		SendRcvDisablingsBeta w = new SendRcvDisablingsBeta();
		w.setVisible(true);
		w.repaint();
	}
