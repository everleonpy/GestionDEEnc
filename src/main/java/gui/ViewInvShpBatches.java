...
import business.InvShpEbBatchesTM;
import business.SessionContext;
import business.UserAttributes;
import business.ViewInvShpBatchesCtrl;
...
public class ViewInvShpBatches extends JFrame {
	...
	private ViewInvShpBatchesCtrl ctrl;
	...
	public ViewInvShpBatches () {
	    ...
	    this.ctrl = new ViewInvShpBatchesCtrl();
	...
	private void openItemsWindow ( long batchId, String batchNumber ) {
		ViewInvShpBatchItemsCtrl ctrl = new ViewInvShpBatchItemsCtrl();
		ctrl.setBatchId(batchId);
		ctrl.setBatchNumber(batchNumber);
	    ViewInvShpBatchItems w = new ViewInvShpBatchItems( this, ctrl );
	    w.setVisible(true);			
	}
	...
	public static void main(String[] args) {
		...
		//
		ViewInvShpBatches w = new ViewInvShpBatches();
		w.setVisible(true);
		w.repaint();
	}
