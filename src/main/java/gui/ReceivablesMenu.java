...
import business.ReceivablesMenuController;
import business.UserAttributes;
import pojo.ListOfValuesSelection;

public class ReceivablesMenu extends JFrame {
	...
	private ReceivablesMenuController ctrl;
	...
	public ReceivablesMenu () {
	    ...
	    this.ctrl = new ReceivablesMenuController();
		// build GUI
		initialize();
		try {		
	...
	private void openSendInvoicesWindow () {
		new SendRcvInvoicesBeta();
		this.dispose();
	}
    
	private void openSendMemosWindow () {
		new SendRcvMemosBeta();
		this.dispose();
	}
	...
	public static void main(String[] args) {
		String port = args[0];
		ReceivablesMenu w = new ReceivablesMenu();
		w.setVisible(true);
		w.repaint();
	}
