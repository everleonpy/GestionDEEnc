...
public class ViewRcvTrxBatchItems extends JDialog {
	...
	private ViewRcvTrxBatchItemsCtrl ctrl;
	 ...
	 */
	public ViewRcvTrxBatchItems ( Frame owner, ViewRcvTrxBatchItemsCtrl ctrl ) {
	...
	public static void main(String[] args) {
		...
		//
		ViewRcvTrxBatchItems w = new ViewRcvTrxBatchItems(null, new ViewRcvTrxBatchItemsCtrl());
		w.setVisible(true);
		w.repaint();
	}
