...
public class ViewInvShpBatchesCtrl {
	/* 
	 * +-------------------------------------------------------------+
	 * |                                                             | 
	 * |                                                             |
	...
	private InvShipmentEbBatch selectedBatch;
	private String selectedBatchNo;
	private ArrayList<InvShipmentEbBatch> batchesList = new ArrayList<InvShipmentEbBatch> ();
	private InvShpEbBatchesTM queryTableModel;
	...
	public InvShipmentEbBatch getSelectedBatch() {
		return selectedBatch;
	}

	public void setSelectedBatch(InvShipmentEbBatch selectedBatch) {
	...
	public ArrayList<InvShipmentEbBatch> getBatchesList() {
		return batchesList;
	}

	public void setBatchesList(ArrayList<InvShipmentEbBatch> batchesList) {
		this.batchesList = batchesList;
	}

	public InvShpEbBatchesTM getQueryTableModel() {
		return queryTableModel;
	}

	public void setQueryTableModel(InvShpEbBatchesTM tableModel) {
	...
	public void getBatchData ( long batchId ) {
		...
		while (itr1.hasNext()) {
			InvShipmentEbBatch i = (InvShipmentEbBatch) itr1.next();
	...
	public ApplicationMessage loadQueryDataModel () {
		try {
			...
			this.batchesList = InvShipmentsEbBatchesDAO.getList(this.batchNumber, this.fromDate, this.toDate);
			return null;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void createQueryItemsTable ( ) {
		if (queryTableModel == null) {
			queryTableModel = new InvShpEbBatchesTM();
		}
		queryTableModel.getModelData ( batchesList );
		queryTableModel.fireTableDataChanged();
	}	

	public InvShpEbBatchesTM createQueryEmptyTable ( ) {
		InvShpEbBatchesTM tm = new InvShpEbBatchesTM();
		tm.getEmptyModel();
		return tm;
	}	
