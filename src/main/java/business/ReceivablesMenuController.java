...
public class ReceivablesMenuController {
    /* 
     * +-------------------------------------------------------------+
     * |                                                             | 
     * |                                                             |
	...
	private String [] menuItems = {" Enviar Facturas", " Enviar Notas", " Evento Cancelacion", " Evento Inutilizacion", " Enviar a Cliente", " Consultar Lotes", " Salir"};
