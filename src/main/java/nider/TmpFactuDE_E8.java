...
public class TmpFactuDE_E8 {
	...
	//
	private TmpFactuDE_E81 gValorItem;
	private TmpFactuDE_E82 gCamIVA;
	
	public TmpFactuDE_E82 getgCamIVA() {
		return gCamIVA;
	}
	public void setgCamIVA(TmpFactuDE_E82 gCamIVA) {
	...
	public TmpFactuDE_E81 getgValorItem() {
		return gValorItem;
	}
	public void setgValorItem(TmpFactuDE_E81 gValorItem) {
