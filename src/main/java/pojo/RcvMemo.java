...
public class RcvMemo {
	...
	private String invoiceCtrlCode;
	...
	public String getgRFileName() {
		return gRFileName;
	}
	public void setgRFileName(String gRFileName) {
	...
	public String getInvoiceCtrlCode() {
		return invoiceCtrlCode;
	}
	public void setInvoiceCtrlCode(String invoiceCtrlCode) {
		this.invoiceCtrlCode = invoiceCtrlCode;
	}
