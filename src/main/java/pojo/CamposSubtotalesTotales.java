...
public class CamposSubtotalesTotales {
	// +------------------------------------------------------------------------------------------+
	// | Grupo       | F                                                                          |
	// | ID          | F001                                                                       |
	// | Padre       | A001                                                                       |
	// | Campo       | gTotSub                                                                    |
	// | Descripcion | Campos de subtotales y totales                                             |
	// +------------------------------------------------------------------------------------------+
	...
	public BigDecimal getdTotCom() {
		return dTotCom;
	}
	public void setdTotCom(BigDecimal dTotCom) {
		this.dTotCom = dTotCom;
	}
